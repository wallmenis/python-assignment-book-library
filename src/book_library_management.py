...
class LibraryDB():
    ...
    def get_book_reviews_by_user(self, book):
        return
...
class Book():
    def __init__(self, ID=-1, title="I", author="do", publisher="not", categories=["exist"], cost=-1.0, shipping_cost=-1.0, copies=-1, bookstores={"here" : -1}):
        self.ID = ID
        self.title = title
        self.author = author
